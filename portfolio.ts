...
export const experience: ExperienceType[] = [
	{
		...
		companyLogo: "img/icons/common/pl-tab-logo.jpg",
		date: "June 2024 – Present",
		desc: "Conducting research on a novel project utilizing OpenCV to capture and analyze visual behaviors of Large Language Models (LLMs). Applying statistical methods to extract, quantify, and interpret various behavioral metrics."
	},

  {
    role: 'Sous Chef',
    company: 'Vietnamese Restaurant',
    companyLogo: 'img/icons/common/chef.jpg',
    date: 'June 2017 – 2018',
